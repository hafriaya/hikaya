...
export default function EditClassPage() {
    ...
    const fetchClassData = async () => {
        try {
            ...
            setLevel(data.level || '');
            setIsActive(data.isActive !== false); // Default to true if not set
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            router.push(`/users/teacher/classes/${classId}`);
        } catch (err) {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 px-4">
                <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 text-center border border-white/20">
                    ...
                    <p className="text-slate-700 text-lg font-medium">Chargement des données de la classe...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-600">Modifiez les informations de la classe</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-slate-500 mt-1">Modifiez le statut de la classe selon vos besoins</p>
                        </div>
